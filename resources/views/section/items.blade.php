...
<div class="flex flex-col w-full">
    ...
    <div
        class="flex flex-wrap items-center justify-start pt-4 ml-16 pb-3 md:ml-16 md:pt-2 md:pb-2 md:h-14 md:border-b md:border-gray-300">
        <div class="flex flex-wrap sm:flex-nowrap w-full items-center justify-between space-y-4 sm:space-y-0">
            ...
            <div
                ...
                <form action="{{ route('section.items') }}" method="GET">
                    <div class="flex bg-green-50 px-3 py-1 ml-1 w-80 shadow-inner shadow-gray-300">
                        <input type="text" name="query" id="search-input" placeholder="Search"
                            class="w-full text-base sm:text-lg border-none outline-none bg-transparent pr-12">
                        <div class=" fixed top-2 ml-64 bg-green-400 shadow-inner shadow-gray-300 h-9 w-14">
                            <button type="submit" class=" px-3 md:px-4 py-2 text-white rounded-md text-xs sm:text-sm"
                ...
                <form action="{{ route('section.items') }}" method="GET">
                    <div id="suggestions"
                        class="absolute top-11 bg-green-100 opacity-90 border border-gray-300 z-50 hidden"
                        style="width: 269px; left: 334px">
            ...
            <div class="w-full md:w-auto flex pb-2 justify-end pr-3">
                <a href="{{ route('section.itemsPage.sell') }}">
                    <button
                        ...
                        style="font-size: 12px;">SELL ITEM</button>
                </a>
            </div>
