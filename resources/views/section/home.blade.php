    ...
    top-[530%] left-[0%] translate-x-[-50%] translate-y-[-50%]">
        ...
        <div class="absolute inset-0 z-1 pointer-events-none">
            <div class="absolute w-full h-full">
                ...
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[17%] top-[45%]">
                </div>
                <div
                ...
                <div
                    class="absolute w-[3px] h-[3px] bg-white rounded-full opacity-50 animate-twinkle left-[50%] top-[20%]">
                </div>
                <div
                    class="absolute w-[4px] h-[4px] bg-white rounded-full opacity-100 animate-pulse left-[65%] top-[53%]">
                </div>

                <div
                    class="absolute w-[3px] h-[3px] bg-white rounded-full opacity-50 animate-twinkle left-[80%] top-[20%]">
                </div>
                <div
                    class="absolute w-[3px] h-[3px] bg-white rounded-full opacity-50 animate-twinkle left-[90%] top-[30%]">
                </div>
                <div
                    class="absolute w-[3px] h-[3px] bg-white rounded-full opacity-30 animate-twinkle left-[85%] top-[40%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-twinkle left-[68%] top-[57%]">
                </div>
                <div
                    class="absolute w-[4px] h-[4px] bg-white rounded-full opacity-40 animate-pulse left-[20%] top-[90%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[47%] top-[55%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-50 animate-pulse left-[17%] top-[26%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-50 animate-pulse left-[20%] top-[60%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-60 animate-pulse left-[10%] top-[40%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[55%] top-[53%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[33%] top-[55%]">
                </div>

                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[60%] top-[35%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[90%] top-[60%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[70%] top-[50%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-70 animate-pulse left-[65%] top-[28%]">
                </div>

                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-100 animate-pulse left-[40%] top-[35%]">
                </div>
                <div
                    class="absolute w-[2px] h-[2px] bg-white rounded-full opacity-50 animate-pulse left-[29%] top-[25%]">
                </div>
                <div
            ...
            <div id="topper" class="flex flex-col animate-fade-in z-20">
                ...
                <div x-data="{
                    ...
                    <div
                        ...
                        <a href="#"
                            @click.prevent="active = 'services'; redirect('{{ route('section.repair') }}')">
                            <div class="relative flex items-center justify-center w-44 ml-8 h-12 rounded-full cursor-pointer transition-all duration-300 text-white z-20
                            hover:bg-red-800 hover:text-white"
                ...
                <div
                    class="flex justify-center text-center mt-1 font-bold font-mono text-white text-2xl tracking-wider">
        ...
        <div class="text-md text-white font-medium z-50" id="logs">
            <p
                class="flex justify-center items-center font-bold font-mono text-white text-5xl tracking-wider mt-40 z-50">
                Recent Activities</p>
