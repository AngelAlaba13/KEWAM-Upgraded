...
<div class="flex flex-col w-full overflow-x-hidden" id="top">
    <div class="fixed left-0 right-0 md:ml-16 pt-6 pb-6 border-b border-gray-300 bg-headerColor z-40 transition-transform duration-300"
        id="navbar">
        <div class="flex w-full justify-between items-center h-5">
            <div class="ml-2 md:ml-14 md:mr-20 text-xl sm:text-2xl text-gray-200">
