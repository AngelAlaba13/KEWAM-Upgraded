...
<div class="bg-gradient-to-r from-[#961c1c] to-[hsl(0,87%,15%)]">
    <!-- Blurred Circle -->
    <div class="absolute w-[470px] h-[400px] 
             bg-[#ff3b3b] 
        ...
        <div class="flex flex-col w-full overflow-x-hidden" id="top">
            ...
            <div class="flex flex-col md:ml-16 animate-fade-in z-20">
                <div class="flex flex-row justify-evenly mt-56 h-44  p-14 pl-44 pr-44 ">
                    <div
                        class="flex items-center justify-center w-40 h-14 rounded-full border-[3px] p-4 text-white border-white">
                        ss
                    </div>
                    <div class="flex items-center justify-center w-40 h-14 rounded-full text-white bg-violet-300 ">
                        ss
                    </div>
                    <div class="flex items-center justify-center w-40 h-14 rounded-full text-white bg-green-300">
                        ss
                    </div>

                    <div class="flex items-center justify-center w-40 h-14 rounded-full text-white bg-yellow-300">
                        ss
                    </div>
                </div>
